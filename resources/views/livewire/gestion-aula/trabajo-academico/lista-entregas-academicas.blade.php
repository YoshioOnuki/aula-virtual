                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    @if($trabajo->created_at >
                                                    $trabajo_academico->fecha_fin_trabajo_academico)
                                                ...
                                                <td>
                                                    ...
                                                    <a href="{{ route('carga-academica.detalle.trabajo-academico.alumnos.entrega',
                                                        ...
                                                        @if($item->trabajoAcademicoAlumno[0]->estadoTrabajoAcademico->nombre_estado_trabajo_academico
                                                        === 'Entregado')
                                                        Revisar entrega
                                                        @else
                                                        Ver entrega
