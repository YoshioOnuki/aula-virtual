                                ...
                                <form autocomplete="off" wire:submit="guardar_respuesta" novalidate>
                                    <div class="card-body">
                                        <div class="row g-3">
                                            ...
                                            <div class="col-lg-12">
                                                <label for="descripcion_foro_respuesta"
                                                    class="form-label required @error('descripcion_foro_respuesta') text-danger @enderror">
                                                    Respuesta
                                                </label>
                                                <div wire:ignore>
                                                    <textarea class="form-control"
                                                        wire:model.lazy="descripcion_foro_respuesta"
                                    ...
                                    <div class="card-footer d-flex justify-content-between">
                                        <div class="ms-auto">
                                            <button type="submit" class="btn btn-primary w-100"
                                                ...
                                                wire:target="guardar_respuesta, descripcion_foro_respuesta">
