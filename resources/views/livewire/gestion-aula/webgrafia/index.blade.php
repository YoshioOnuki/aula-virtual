                                ...
                                <div class="text-secondary row">
                                    ...
                                    @if ($usuario->esRolGestionAula('DOCENTE', $id_gestion_aula_usuario) && $tipo_vista === 'carga-academica')
                                        <div class="col-lg-5 col-3 d-flex justify-content-end">
                                            <a class="btn btn-primary d-none d-md-inline-block" wire:click="abrir_modal_webgrafia_agregar()">
                                            ...
                                            <a class="btn btn-primary d-md-none btn-icon" wire:click="abrir_modal_webgrafia_agregar()">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24"
                                                    height="24" viewBox="0 0 24 24" stroke-width="2"
                                                    stroke="currentColor" fill="none" stroke-linecap="round"
                                                    stroke-linejoin="round">
                                    ...
                                    @forelse ($webgrafias as $item)
                                        <tr>
                                            ...
                                            <td>
                                                    ...
                                                    <div class="btn-list flex-nowrap">
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-end">
                                                                <a class="dropdown-item" style="cursor: pointer;" wire:click="redirect_link({{ $item->id_webgrafia }})">
                                                                    Ir al link
                                                                </a>
                                                                <a class="dropdown-item" style="cursor: pointer;" wire:click="abrir_modal_webgrafia_editar({{ $item->id_webgrafia }})">
                                                                    Editar
                                                                </a>
                                                            </div>
                                                        </div>
                                                ...
                                                @else
                                                    <button type="button"
                                                    class="btn btn-outline-primary" wire:click="redirect_link({{ $item->id_webgrafia }})">
