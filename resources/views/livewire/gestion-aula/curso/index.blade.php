            ...
            <div class="card card-md card-stacked animate__animated animate__fadeIn animate__faster">
                ...
                <div class="card-body">
                    <div class="row row-cards d-flex justify-content-start">
                        ...
                        @if ($cargando)
                        @for($i = 0; $i < $cantidad_cursos; $i++) <div
                            class="col-sm-4 col-lg-4 col-xl-3 p-xl-2 p-lg-1 p-2" wire:init="load_cursos">
                            <div class="card placeholder-glow ">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mt-3 d-flex justify-content-end">
                                        <a href="#" tabindex="-1" class="btn btn-secondary disabled placeholder col-3"
                                            aria-hidden="true"></a>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-sm-4 col-lg-4 col-xl-3 p-xl-2 p-lg-1 p-2">
                        <div
                            ...
                            <div class="card-avatar avatar avatar-smm rounded-circle">
                                @if (session('tipo_vista') === 'alumno')
                                <img src="{{ $foto_docente[$item->gestionAula->id_gestion_aula] }}" alt="avatar">
                                @elseif(session('tipo_vista') === 'docente')
                                ...
                                <div style="cursor: pointer;"
                                    ...
                                    <div class="d-flex align-items-center" style="height: 75px;">
                                        <div>
                                            ...
                                            <div class="text-uppercase">
                                                {{ $item->gestionAula->curso->nombre_curso }} - GRUPO "{{
                                                $item->gestionAula->grupo_gestion_aula }}"
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="d-flex mb-1 mt-2">
                                        <div class="text-muted fs-5">
                                            Progreso:
                                            {{ $numero_progreso_realizados[$item->id_gestion_aula_usuario] ?? '0' }}/{{
                                            $numero_progreso[$item->id_gestion_aula_usuario] ?? '0' }}
                                        </div>
                                    ...
                                    <div class="progress progress-sm">
                                        <div class="progress-bar bg-{{ color_porcentaje($progreso[$item->id_gestion_aula_usuario] ?? 0) }}"
                                            ...
                                            <span class="visually-hidden">{{ $progreso[$item->id_gestion_aula_usuario]
                                                ?? 0 }}%
                                                Complete</span>
                                        </div>
                                    </div>
                                ...
                                <div class="d-flex align-items-center mt-3">
                                    <div class="ms-auto">
                                        ...
                                        <button class="switch-icon switch-icon-scale" data-bs-toggle="switch-icon"
                                            wire:click="curso_favorito({{ $item->id_gestion_aula_usuario }})">
