                                            ...
                                            <div class="card placeholder-glow">
                                                <div class="card-body">
                                                    <div class="d-flex justify-content-between mb-5">
                                                        ...
                                                        <div class="placeholder bg-primary"
                                                            style="height: 1.5rem; width: 1.5rem;"></div>
                                                    </div>
                                                    <div>
                                                    ...
                                                    <div class=" d-flex justify-content-end">
                                                        <a href="#" tabindex="-1"
                                                            class="btn btn-cyan disabled placeholder col-sm-3 col-lg-4 col-xl-2 d-none d-md-inline-block me-2"
                                                            aria-hidden="true"></a>
                                                        <a href="#" tabindex="-1"
                                                            class="btn btn-cyan disabled placeholder col-1 d-md-none me-2 btn-icon"
                                                            aria-hidden="true"></a>
                                                        <a href="#" tabindex="-1"
                                                            class="btn btn-success disabled placeholder col-sm-3 col-lg-4 col-xl-2 d-none d-md-inline-block"
                                                            aria-hidden="true"></a>
                                                        <a href="#" tabindex="-1"
                                                            class="btn btn-success disabled placeholder col-1 d-md-none btn-icon"
                                                            aria-hidden="true"></a>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="d-flex justify-content-between">
                                                        ...
                                                        <div>
                                                            <h5 class="card-title d-flex align-items-center">
                                                                <img src="/media/icons/icon-archivo-pdf.webp"
                                                        ...
                                                        <div class="mt-0 mb-auto">
                                                            @if ($estado_recurso === 0)
                                                                <span class="text-primary cursor-pointer"
                                                                    wire:click="cambiar_estado_recurso()">
                                                                    <svg xmlns="http://www.w3.org/2000/svg"
                                                                        width="24" height="24"
                                                                        viewBox="0 0 24 24" fill="none"
                                                                        stroke="currentColor" stroke-width="2"
                                                                        stroke-linecap="round" stroke-linejoin="round"
                                                                        class="icon icon-tabler icons-tabler-outline icon-tabler-circle-check svg-small">
                                                            ...
                                                            @elseif($estado_recurso === 1)
                                                                <span class=" text-primary cursor-pointer"
                                                                    ...
                                                                    <svg xmlns="http://www.w3.org/2000/svg"
                                                                        ...
                                                                        class="icon icon-tabler icons-tabler-filled icon-tabler-circle-check svg-small">
                                                                        <path stroke="none" d="M0 0h24v24H0z"
                                                                            fill="none" />
                                                                        <path
                                                        ...
                                                        <div>
                                                            @if ($usuario->esRol('DOCENTE'))
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                                    ...
                                                                    wire:click="abrir_modal_recurso_editar(1)">
                                                                    <path stroke="none" d="M0 0h24v24H0z"
                                                                        fill="none" />
                                                                    <path
                                                        ...
                                                        <div>
                                                            <button class="btn btn-cyan d-none d-md-inline-block me-2">
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                                    ...
                                                                    <path
                                                                        d="M22 12c0 1.66 -5.33 5 -10 5s-10 -3.34 -10 -5s5.33 -5 10 -5s10 3.34 10 5" />
                                                                </svg>
                                                                Vista Previa
                                                            </button>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-lg-12">
                                ...
                                <input type="file" class="form-control @error('archivo') is-invalid @enderror"
                                    id="archivo" wire:model.live="archivo" />
                                @error('archivo')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
