                                        ...
                                        <div class="d-flex">
                                            ...
                                            <div>
                                                ...
                                                <div class="text-yellow">
                                                    @if ($es_docente)
                                                    Por favor, sube el sílabus del curso para que los alumnos puedan acceder a él.
                                                    @else
                                                    Por favor, verifica más tarde o contacta con el docente asignado para más información.
                                                    @endif
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-12">
                                        <div class="row g-2">
                                            ...
                                            <div class="col-12">
                                                <div class="placeholder col-12 bg-secondary" style="height: 17px;">
                                                </div>
                                                <div class="col-12"></div>
                                            </div>
                                        </div>
