                        ...
                        <div class="card-body">
                            <div class="row row-cards d-flex justify-content-start">
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex justify-content-between align-items-center">
                                                <!-- Vista Previa y Descargar botones aquí -->
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icons-tabler-outline icon-tabler-circle-check svg-small text-primary">
                                                    <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                                                    <path d="M12 12m-9 0a9 9 0 1 0 18 0a9 9 0 1 0 -18 0" />
                                                    <path d="M9 12l2 2l4 -4" />
                                                </svg>
                                                <div>
                                                    <button class="btn btn-cyan">Vista Previa</button>
                                ...
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-body">
                                            <h5 class="card-title cursor-pointer">Nombre de lectura</h5>
                                            <p class="card-text"><small class="text-muted">Publicado el 20/12/2021</small></p>
