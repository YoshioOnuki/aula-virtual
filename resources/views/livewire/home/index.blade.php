            ...
            <div class="row">
                <div class="col col-md-8 col-lg-8 col-xl-8 col-sm-12 col-12">
                    <div class="card card-stacked animate__animated animate__fadeIn   mb-3">
                        <div class="card-header d-flex justify-content-center align-items-center" " style=" background:
                            rgb(12, 166, 120);">
                        ...
                        <div class="card-body overflow-auto" style="height: 610px;">
                            <div class="row row-cards d-flex justify-content-start" wire:init="load_cursos">
                                    ...
                                    <div class="card placeholder-glow">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="mt-3 d-flex justify-content-end">
                                                <a href="#" tabindex="-1"
                                                    class="btn btn-secondary disabled placeholder col-3"
                                                    aria-hidden="true"></a>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-sm-6 col-lg-6 col-xl-4 p-xl-2 p-lg-1 p-2">
                                    <div class="card card-sm hover-shadow custom-card cursor-pointer animate__animated animate__zoomIn"
                                            ...
                                            <div>
                                                ...
                                                <div class="d-flex mb-1 mt-2">
                                                    <div class="text-muted fs-5">
                                                        Progreso:
                                                        {{ $numero_progreso_realizados[$item->id_gestion_aula_usuario]
                                                        ??
                                                        '0' }}/{{ $numero_progreso[$item->id_gestion_aula_usuario] ??
                                                        '0' }}
                                                    </div>
                ...
                <div class="col col-md-4 col-lg-4 col-xl-4 col-sm-12 col-12">
                    <div class="card card-stacked animate__animated animate__fadeIn mb-3">
                        ...
                        <div class="card-body overflow-auto" style="height: 610px;">
                            <div
                                class="d-flex flex-column align-items-cent justify-content-center gap-5 animate__animated animate__fadeInUpBig animate__delay-1s">
