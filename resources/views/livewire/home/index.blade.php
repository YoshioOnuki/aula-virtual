                        ...
                        <div class="card-body overflow-auto" style="height: 610px;">
                            <div class="row row-cards d-flex justify-content-start" wire:init="load_cursos">
                                ...
                                {{-- @for($i = 0; $i < $cantidad_cursos; $i++) --}} <div
                                    class="col-sm-6 col-lg-6 col-xl-4 p-xl-2 p-lg-1 p-2">
                            ...
                            <div class="col-sm-6 col-lg-6 col-xl-4 p-xl-2 p-lg-1 p-2">
                                <div class="card card-sm hover-shadow custom-card cursor-pointer animate__animated animate__fadeIn  "
                                        ...
                                        <div>
                                            ...
                                            <div class="d-flex mb-1 mt-2">
                                                <div class="text-muted fs-5">
                                                    ...
                                                    '0' }}/{{ $numero_progreso[$item->id_gestion_aula_usuario] ?? '0' }}
                                                </div>
