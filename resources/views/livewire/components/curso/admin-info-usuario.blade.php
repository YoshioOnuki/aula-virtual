        ...
        <div class="card-body">
            <div class="row g-2 align-items-center">
                ...
                <div class="col">
                    ...
                    <div class="page-subtitle">
                        <div class="row">
                            ...
                            <div x-data="{ isCopied: false }" class="col-auto">
                                <a class="text-reset cursor-pointer copy-to-clipboard" @click="navigator.clipboard.writeText('{{ $usuario->persona->documento_persona }}')
                                        .then(() => {
                                            isCopied = true;
                ...
                <div class="col-auto">
                    ...
                    <a href="#" class="btn btn-azure d-md-none btn-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                            stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                            class="icon icon-tabler icons-tabler-outline icon-tabler-address-book">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
