            ...
            <div class="d-flex justify-content-between">
                <div class="d-flex align-items-start">
                    ...
                    <div class="flex-fill">
                        ...
                        @if (!$modo_respuesta && $es_alumno)
                        <div class="mt-4 mb-1">
                            <a class="btn btn-primary cursor-pointer"
                                href="{{ $tipo_vista === 'cursos' ?
                                    route('cursos.detalle.foro.detalle.respuesta', ['id_usuario' => $id_usuario_hash, 'tipo_vista' =>  $tipo_vista, 'id_curso' => $id_gestion_aula_hash, 'id_foro' => Hashids::encode($foro->id_foro)]) :
                                    route('carga-academica.detalle.foro.detalle.respuesta', ['id_usuario' => $id_usuario_hash, 'tipo_vista' =>  $tipo_vista, 'id_curso' => $id_gestion_aula_hash, 'id_foro' => Hashids::encode($foro->id_foro)]) }}">
