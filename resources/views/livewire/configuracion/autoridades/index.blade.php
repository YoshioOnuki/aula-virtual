                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a wire:click="abrir_modal_estado({{ $item->id_autoridad }}, 0)" class="text-decoration-none cursor-pointer">
                                            ...
                                            <a wire:click="abrir_modal_estado({{ $item->id_autoridad }}, 1)" class="text-decoration-none cursor-pointer">
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <div>
                                            ...
                                            <div class="text-dark">
                                                ...
                                                Esto {{ $modo === 1 ? 'permitirá' : 'restringirá' }} su visualización en el sistema.
                                            </div>
                                        </div>
                                    </div>
                                </div>
