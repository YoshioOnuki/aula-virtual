...
class Autoridad extends Model
{
    ...
    /**
     * Get the cargo_autoridad attribute.
     *
     * @return string
     */
    public function getCargoAutoridadAttribute(): string
    {
        return $this->cargo->nombre_cargo;
    }

    /**
     * Get the facultad_autoridad attribute.
     *
     * @return string
     */
    public function getFacultadAutoridadAttribute(): string
    {
    ...
    /**
     * Scope a query to search by estado active.
     *
     * @param \Illuminate\Database\Eloquent\Builder $query
     * @return \Illuminate\Database\Eloquent\Builder
     */
    ...
    /**
     * Scope a query to search by estado inactive.
     *
     * @param \Illuminate\Database\Eloquent\Builder $query
     * @return \Illuminate\Database\Eloquent\Builder
     */
